...
<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h5 class="page-title">ADD NEW URINE EXAMINTION</h5>
            <ol class="breadcrumb">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    {!! Form::open(['route' =>
                                    ['urine-examination.store'],'autocomplete'=>'off'])
                                    !!} {!! csrf_field() !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            {!!Form::text('patientId','',['class' => 'form-control', 'placeholder' =>'Enter Registration Number','id'=>'id-opd-regnum'])
                                            !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name',
                                                'Referred By') !!}
                                                 {!! Form::text('referredBy','',['class' =>'form-control','placeholder' =>'Enter Patient Name','id'=>'consultant','readonly'=>true])
                                                !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name', 'Bile
                                                Pigments') !!} {!!
                                                Form::text('bilePigments','',
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter Bile Pigments']) !!}
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name', 'Bence
                                                Jones Proteins') !!} {!!
                                                Form::text('benceJonesProteins','',
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter Bence Jones Proteins'])
                                                !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name',
                                                'Epithellal Cells') !!} {!!
                                                Form::text('epithellalCells','',
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter Epithellal Cells']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
