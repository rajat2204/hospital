...
<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h5 class="page-title">EDIT X-RAY EXAMINTION</h5>
            <ol class="breadcrumb">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    {!! Form::open(['route' =>
                                    ['x-ray.update',$xrayexamData->id],'method'=>'PUT','autocomplete'=>'off'])
                                    !!} {{ Form::hidden('status', '1') }}
                                    {{ Form::hidden('age',$xrayexamData->age,['id'=>'age']) }}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name', 'OPD Registration Number') !!} 
                                                {!! Form::text('patientId',$xrayexamData->patientId,['class' => 'form-control
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                Name') !!} {!!
                                                Form::text('patientName',$xrayexamData->getPatientDetails->patientName,
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter Patient
                                                Name','id'=>'patientName','readonly'])
                                                !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name', 'OPD
                                                Date') !!} {!!
                                                Form::date('opdDate',$xrayexamData->getPatientDetails->regDate,
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter Registration
                                                Date','id'=>'regDate','readonly'])
                                                !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name',
                                                'Referred By') !!} {!!
                                                Form::text('referredBy',$xrayexamData->referredBy,
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'EnterReferred By
                                                Name','id'=>'consultant','readonly'])
                                                !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                Form::text('investigationAdvised',$xrayexamData->investigationAdvised,
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter Investigation
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                Date') !!} {!!
                                                Form::date('date',$xrayexamData->date,
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter OT Date']) !!}
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name',
                                                'Description') !!} {!!
                                                Form::textarea('description',$xrayexamData->description,
                                                ['class' =>
                                                'form-control','placeholder' =>
                                                'Enter Description','rows' => 3,
                                                'cols' => 10,]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name',
                                                'Remarks') !!} {!!
                                                Form::textarea('remark',$xrayexamData->remark,
                                                ['class' =>
                                                'form-control','placeholder' =>
