...
<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h5 class="page-title">ADD NEW ULTRASOUND </h5>
            <ol class="breadcrumb">
                    ...
                    <div class="card">
                       <div class="card-header">
                            <div class="col-md-12 col-sm-6 col-xs-12">
                               {{--  <span class="pull-left">
                                ...
                                <span class="pull-right">
                                      <a href="{{ route('ultrasound.filter') }}">
                                        <span class="pull-right btn btn-success ">
                                            <i class="fa fa-list"></i> SHOW/SEARCH OLD ULTRASOUNDS</span>
                                        </a>
                                </span>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    {!! Form::open(['route' => ['ultrasound.store'],'autocomplete'=>'off'])!!} 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('Ultrasound Type',
                                                'Ultrasound Type:*') !!}
                                                {!! Form::select('ultrasound_type', array( ''=>'----Select Ultrasound Type----','Lower Abdomen'=>'Lower Abdomen','Upper Abdomen'=>'Upper Abdomen','Whole Abdomen' =>'Whole Abdomen','F.W.B.'=>'F.W.B.', ), 'S',['class' =>'form-control','id'=>'ultrasound_type']) !!}
                                                <div class="error">{{ $errors->first('ultrasound_type') }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
