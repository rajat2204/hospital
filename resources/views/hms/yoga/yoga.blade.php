...
<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h5 class="page-title">ADD NEW YOGA EXAMINTION</h5>
            <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            'yoga.store','files'=>'true','id'=>'profile-form','autocomplete'=>'off'))
                            !!}
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::text('abc','', [ 'class' => 'form-control opd', 'placeholder' => 'Enter OPD
                                    ...
                                    <div class="col-md-offset-2 col-sm-2">
                                        <div class="form-group">
                                            {!! Form::label('opdDate', 'OPD
                                            Date:*') !!}
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::text('opdDate', '', ['class' =>
                                            'form-control','id'=>'id-opddate','name'=>'opdDate','placeholder'=>'OPD Date','readonly'=>'readonly']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::text('ipdRegNum', '',
                                            ['class' =>
                                            'form-control','id'=>'ipdRegNum','name'=>'ipdRegNum','placeholder'=>'IPD Registration number','readonly'=>'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-offset-2 col-sm-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::text('ipdRegDate', '',
                                            ['class' =>
                                            'form-control','id'=>'ipdRegDate','name'=>'ipdDate','placeholder'=>'IPD Date','readonly'=>'readonly']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::text('age', '', ['class'
                                            =>
                                            'form-control','id'=>'age','name'=>'age','placeholder'=>'AGE','readonly'=>'readonly'])
                                            !!}
                                        </div>
                                    </div>
                                    <div class="col-md-offset-2 col-sm-2">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::text('gender','',
                                            ['class' =>
                                            'form-control','id'=>'gender','name'=>'gender','placeholder'=>'GENDER','readonly'=>'readonly'])
                                            !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            {!! Form::text('address', '',
                                            ['class' =>
                                            'form-control','id'=>'address','readonly'=>'readonly','placeholder'=>'Enter Address']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::date('yogadate',Carbon\Carbon::today()->format('Y-m-d'),
                                            ['class' =>
                                            'form-control','id'=>'yogadate','name'=>'yogadate'])
                                            !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            {!! Form::select('disease',
                                            $diseaseList,'', [ 'class' =>
                                            'form-control disease', 'id'=>'disease',
                                            'placeholder' => '--Select
                                            Disease--' ]) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            {!! Form::text('exersise', '',
                                            ['class' =>
                                            'form-control','id'=>'exersise','name'=>'exersise','readonly'=>true,'placeholder'=>'Enter Excersise'])
                                            !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            ...
                                            =>
                                            'form-control','id'=>'other','name'=>'other','placeholder'=>'Enter Other'])
                                            !!}
                                        </div>
                                    </div>
                                </div>
