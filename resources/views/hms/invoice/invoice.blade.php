...
<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h5 class="page-title">ADD NEW INVOICE </h5>
            <ol class="breadcrumb">
                    ...
                    <div class="card">
                       <div class="card-header">
                                ...
                                <span class="pull-right">
                                      <a href="{{ route('invoice.filter') }}">
                                        <span class="pull-right btn btn-success ">
                                            <i class="fa fa-list"></i> SHOW/SEARCH INVOICES</span>
                                        </a>
                                </span>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    {!! Form::open(['route' => ['invoice.store'],'autocomplete'=>'off'])!!} 
