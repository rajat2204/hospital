                ...
                <div class="side-app">
                    <div class="page-header">
                        ...
                        <ol class="breadcrumb float-right">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">SEMENE EXAM  REPORTS</li>
                        </ol>
                    </div>
                    <div class="col-md-12  col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <p class="card-title">SEMENE EXAM - REPORT MONTH WISE</p>
                            </div>
                            <div class="card-body">
                                {!! Form::open(array('id'=>'semene')) !!}
                                <div class="row">
                                    <div class="col-lg-2">
                                ...
                                <center>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            {!! Form::button('Submit', ['class'=> 'btn btn-primary','id'=>'id-semene']) !!}
                                ...
                                <div class="card">  
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="semene-table" class="table table-striped table-bordered w-100">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Year/Month</th>
                                                        <th>No. Of Semene Examination</th>
                                                        <th>Remark</th>
...
<script type="text/javascript">  
  $(document).ready(function() {
    $('#id-semene').on('click',function() {
      ...
      $('#semene-table').DataTable({
        processing: true,
        serverSide: true,
        bDestroy: true,
        ajax: {   url: "{{ route('semeneReport.search') }}",
        type: "POST",
