          		...
          		<div class="side-app">
	             	<div class="page-header">
	                	...
	                	<ol class="breadcrumb float-right">
			                ...
			                <li class="breadcrumb-item active" aria-current="page">ECG Reports</li>
	            		</ol>
	            	</div>
		            <div class="col-md-12  col-xl-12">
		                <div class="card">
		                	<div class="card-header">
		                  		<p class="card-title">ECG - REPORT MONTH WISE</p>
		                    </div>
		                 	<div class="card-body">
		                       	{!! Form::open(array('id'=>'ecg')) !!}
		                    	<div class="row">
		                        	<div class="col-lg-2">
			                    ...
			                    <center>
			                        <div class="col-sm-12">
			                            <div class="form-group">
			                                {!! Form::button('Submit', ['class'=> 'btn btn-primary','id'=>'id-ecg']) !!}
				                ...
				                <div class="card">  
						            ...
						            <div class="card-body">
							            <div class="table-responsive">
							                <table id="ecg-table" class="table table-striped table-bordered w-100">
							                    <thead>
							                      	<tr>
									                    <th>Id</th>
									                    <th>Year/Month</th>
...
<script type="text/javascript">  
  $(document).ready(function() {
    $('#id-ecg').on('click',function() {debugger
      ...
      $('#ecg-table').DataTable({
        ...
        serverSide: true,
        bDestroy: true,
        ajax: {   url: "{{ route('ecgReport.search') }}",
        type: "POST",
