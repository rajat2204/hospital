          		...
          		<div class="side-app">
	             	<div class="page-header">
	                	...
	                	<ol class="breadcrumb float-right">
			                ...
			                <li class="breadcrumb-item active" aria-current="page">STOOL EXAM REPORTS</li>
	            		</ol>
	            	</div>
		            <div class="col-md-12  col-xl-12">
		                <div class="card">
		                	<div class="card-header">
		                  		<p class="card-title">STOOL - REPORT MONTH WISE</p>
		                    </div>
		                 	<div class="card-body">
		                       	{!! Form::open(array('id'=>'stool')) !!}
		                    	<div class="row">
		                        	<div class="col-lg-2">
			                    ...
			                    <center>
			                        <div class="col-sm-12">
			                            <div class="form-group">
			                                {!! Form::button('Submit', ['class'=> 'btn btn-primary','id'=>'id-stool']) !!}
				                ...
				                <div class="card">  
					                <header class="card-header"> 
				                        <div class="col-md-8" id="month"></div>
				                     	<span class="pull-right"> <a href="javascript:;" onclick="printDiv('STOOL - REPORT MONTH WISE')" class="btn btn-sm btn-info"> <i class="fa fa-print"></i> Print </a></span>
				                    </header>         
						            <div class="card-body">
							            <div class="table-responsive">
							                <table id="stool-table" class="table table-striped table-bordered w-100">
							                    <thead>
							                      	<tr>
									                    <th>Id</th>
									                    <th>Year/Month</th>
...
<script type="text/javascript">  
  $(document).ready(function() {
    $('#id-stool').on('click',function() {
      ...
      $('#stool-table').DataTable({
        processing: true,
        serverSide: true,
        bDestroy: true,
        ajax: {   url: "{{ route('stoolReport.search') }}",
        type: "POST",
