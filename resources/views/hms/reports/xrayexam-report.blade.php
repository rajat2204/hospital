                ...
                <div class="side-app">
                    <div class="page-header">
                        ...
                        <ol class="breadcrumb float-right">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">X-RAY EXAM  REPORTS</li>
                        </ol>
                    </div>
                    <div class="col-md-12  col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <p class="card-title">X-RAY EXAM - REPORT MONTH WISE</p>
                            </div>
                            <div class="card-body">
                                {!! Form::open(array('id'=>'xray')) !!}
                                <div class="row">
                                    <div class="col-lg-2">
                                ...
                                <center>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            {!! Form::button('Submit', ['class'=> 'btn btn-info','id'=>'id-xray']) !!}
                                ...
                                <div class="card">  
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="xray-table" class="table table-striped table-bordered w-100">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Year/Month</th>
                                                        <th>No. Of Xray Examination</th>
                                                        <th>Remark</th>
...
<script type="text/javascript">  
  $(document).ready(function() {
    $('#id-xray').on('click',function() {
      ...
      $('#xray-table').DataTable({
        processing: true,
        serverSide: true,
        bDestroy: true,
        ajax: {   url: "{{ route('xrayExamReport.search') }}",
        type: "POST",
