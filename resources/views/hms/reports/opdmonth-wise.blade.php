                ...
                <div class="side-app">
                    <div class="page-header">
                        ...
                        <ol class="breadcrumb float-right">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">OPD MONTH WISE REPORTS</li>
                        </ol>
                    </div>
                    <div class="col-md-12  col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <p class="card-title">OPD - REPORT MONTH WISE</p>
                            </div>
                            <div class="card-body">
                                {!! Form::open(array('id'=>'opd')) !!}
                                <div class="row">
                                    <div class="col-lg-1">
                                ...
                                <center>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            {!! Form::button('Submit', ['class'=> 'btn btn-info','id'=>'id-opd']) !!}
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="card">  
                                    <header class="card-header"> 
                                        ...
                                        <span class="pull-right"> <a href="javascript:;" onclick="printDiv('X-RAY EXAM - REPORT MONTH WISE')" class="btn btn-sm btn-info"> <i class="fa fa-print"></i> Print </a>
                                        </span>
                                    </header>         
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="opd-table" class="table table-striped table-bordered w-100">
                                                <thead>
                                                    <tr role="row">
                                                        <th >#</th>
                                                        <th >Date</th>
  ...
  $(document).ready(function() {
    $('#id-opd').on('click',function() {
      ...
      $('#opd-table').DataTable({
        ...
        serverSide: true,
        bDestroy: true,
        ajax: {   url: "{{ route('opdExamReport.search') }}",
        type: "POST",
        data:{fromDate: $('#fromDate').val(), toDate: $('#toDate').val(),_token:_token,department: jQuery('#department').val()}},
        columns: [
            { data: 'sn', name: 'sn' },
